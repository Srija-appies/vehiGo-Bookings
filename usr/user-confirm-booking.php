  ...
  if(isset($_POST['book_vehicle']))
    {
            ...
            $query="update tms_user set u_car_type=?, u_start_date=?,u_end_date=?, u_car_regno=?, u_car_book_status=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('sssssi', $u_car_type, $u_start_date,$u_end_date, $u_car_regno, $u_car_book_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
...
<body id="page-top">
 <!--Start Navigation Bar-->
  ...
  <input type="date" class="form-control" id="startDate" name="u_start_date">
</div>
<div class="form-group">
  <label for="endDate">End Date</label>
  <input type="date" class="form-control" id="endDate" name="u_end_date">
        </div>
            <div class="form-group">
  <label for="paymentMode">Payment Mode</label>
  <select class="form-control" id="paymentMode" name="u_payment_mode">
